...
- [ ] Solution avoids unnecessary cleverness
- [ ] Architecture is immediately understandable
- [ ] Complex solutions documented with simpler alternatives considered

**YAGNI Compliance**: Are we implementing only what's needed now?
- [ ] No speculative features or future-proofing
- [ ] Each feature has clear, immediate business value
- [ ] No "just in case" code

**Code Readability**: Will this be readable and maintainable?
- [ ] Self-documenting through clear naming and structure
- [ ] Minimal complexity in implementation approach
- [ ] Clear separation of concerns

**Selective Dependencies**: Are third-party choices justified?
- [ ] Dependencies are polished, stable, and actively maintained
- [ ] Each dependency solves a real problem vs custom implementation
- [ ] Dependency choices documented with rationale
...
- [ ] Patterns match current requirements, not imagined future ones
- [ ] Starting simple with evolution path identified
