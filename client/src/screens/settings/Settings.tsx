...
import { ActivitySquare, Palette, Info, Database, RefreshCw, Download, ExternalLink, Loader2, Calendar } from "lucide-react";
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Used for weekly reports and calendar views</p>
            </div>
            <Select
              defaultValue={String(getLocaleWeekStart())}
              onValueChange={(v) => {
                setWeekStart(Number(v) as 0 | 1);
